...
/* harmony default export */ var selectortype_script_index_0_src = ({
  ...
  methods: {
    ...
    mouseListener(e) {
      ...
      // var _zoomDirection = _isMac ? 1 : -1; // ? wind-更改mac双指放大方向
      var zoomSensiNum = _isMac ? 3 : 5;// ? wind-更改源码灵敏度
      var _zoomDirection = -1;
      if (_deltaY > 0) {
        this.zoom(zoomSensiNum * _zoomDirection, userZoomCenter);
      } else {
        this.zoom(-zoomSensiNum * _zoomDirection, userZoomCenter);
      }
    },
